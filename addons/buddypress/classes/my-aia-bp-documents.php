 ...
 * @since 5.0
 */
class BP_MY_AIA_DOCUMENT_Component extends BP_Component {
	...
	function includes( $includes = array() ) {
		...
		$includes = array(
			...
			//'addons/buddypress/screens/my-document-edit.php',
			//'addons/buddypress/screens/document-status.php',
			//'addons/buddypress/screens/attending.php',
			//'addons/buddypress/screens/my-bookings.php',
			//'addons/buddypress/screens/my-document.php'
		);
	...
	function setup_globals( $args = array() ) {
		...
		if ( !defined( 'BP_MY_AIA_DOCUMENTS_SLUG' ) )
			define ( 'BP_MY_AIA_DOCUMENTS_SLUG', str_replace('/','-', 'documents') );

		// Set up the $globals array to be passed along to parent::setup_globals()
		$globals = array(
			'slug'                  => BP_MY_AIA_DOCUMENTS_SLUG,
		...
		$bp->{$this->id}->link = trailingslashit($bp->loggedin_user->domain).BP_MY_AIA_DOCUMENTS_SLUG.'/';
	}
	...
	public function setup_nav( $main_nav = array(), $sub_nav = array() ) {
		...
		$main_nav = array(
			'name' => __( 'Mijn Documents', 'my-aia'),
			'slug' => BP_MY_AIA_DOCUMENTS_SLUG,
			'position' => 90,
			'screen_function' => 'my_aia_bp_my_documents',
		...
		/* Create SubNav Items */
		/*$sub_nav[] = array(
			'name' => __( 'Mijn Document Aanpassen', 'my-aia'),
			'slug' => 'my-document-edit',
			'parent_slug' => BP_MY_AIA_DOCUMENTS_SLUG,
			'parent_url' => $my_aia_link,
			'screen_function' => 'my_aia_bp_my_document_edit',
			'position' => 10,
			'user_has_access' => bp_is_my_profile()
		);
		...
		$sub_nav[] = array(
			...
			'parent_slug' => BP_MY_AIA_DOCUMENTS_SLUG,
			'parent_url' => $my_aia_link,
			'screen_function' => 'my_aia_bp_my_document_status',
			'position' => 20,
...
//CSS and JS Loading
function bp_my_aia_documents_enqueue_scripts( ){
...
function bp_my_aia_document_messages_js_compat() {
...
define('MY_AIA_BP_MY_DOCUMENTS',true); //so we know
?>