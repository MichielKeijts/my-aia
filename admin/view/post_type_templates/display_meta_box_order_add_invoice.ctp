...
<div class='<?php if ($this->invoice) echo "hidden"; ?>' id='select_invoice'>
...
<div class='<?php if (!$this->invoice) echo "hidden"; ?>' id='show_invoice'>
	<p>Factuur (<span id='invoice_number'><?= $this->invoice->invoice_number; ?></span>)</p>
	<p><a href='<?= $this->invoice->pdf_link; ?>' class='pdf-open'>PDF</a></p>
